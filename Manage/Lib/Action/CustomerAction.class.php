...
class CustomerAction extends CommonAction {
	public function index()
	{
		...
		$Customers = $Address->field('on_member.account,on_member.email,on_member_address.*')->join('on_member ON on_member_address.member_id=on_member.id')->select();//print_r($Customers);exit;
