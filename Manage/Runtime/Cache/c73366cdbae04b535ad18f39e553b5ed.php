...
<div id="AdminLeftConlum">
 ...
 <tr align="left" valign="top">
           ...
           <!--  <tr align="left" valign="top">
            ...
            <tr align="left" valign="top">
                <td width="76">&nbsp;</td>
                <td width="1052"><strong>Audit</strong><br />
                <input name="audit" type="radio" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?>>yes &nbsp;&nbsp;
                <input name="audit" type="radio" value="0" <?php if($info['status'] == 0): ?>checked<?php endif; ?>>no
                </td>
            </tr>
            <tr align="left" valign="top">
                <td>&nbsp;</td>
