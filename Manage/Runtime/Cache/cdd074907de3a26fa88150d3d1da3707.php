...
<div id="maincontainer">
    ...
    <div id="text_holder">
        <div id="logo_area">
        	...
        	<div id="login_text"><strong>Welcome</strong>&nbsp;&nbsp;restaurateur, Chang J Wu&nbsp;&nbsp;|&nbsp;&nbsp;<a href="__APP__/Public/logout/">Log out</a></div>
        	<br style="clear:both" />
        </div>                
        <!--End logo_area Div-->
        <div id="page_content">
        	<div id="navigation_links">
        		<div id="navigation">
        			<div class="links selected"><a href="__URL__/index" >Restaurants</a></div>
...
<div id="BodyContainer">
  ...
  <div id="navigation_links">
   <div id="navigation">
    ...
    <div class="links selected"><a href="__APP__/Order/index/restaurant_id/<?php echo ($_SESSION['restaurant_id']); ?>" class="">Orders(1)</a></div>
  ...
  <div id="tab_items">
    <ul>
      <li> <a href="?mod=order&item=main&cid=856" class="">View Approved Orders</a> </li>
      |
      <li> <a href="?mod=order&item=approve&cid=856" class="">New Orders</a> </li>
      |
