...
<form name="form1" method="post" action="__APP__/Menus/add_Item"  enctype="multipart/form-data">
  ...
  <tr align="left" valign="top">
      ...
      <input name="is_item" type="radio"  id="is_item1" value="1" <?php if($info['is_item'] == 1): ?>checked<?php endif; ?>>  yes  
      <input name="is_item" type="radio"  id="is_item2" value="0" <?php if($info['is_item'] == 0): ?>checked<?php endif; ?>>  no      </td>
    </tr>
    <tr align="left" valign="top">
      <td colspan="2"><strong>Is Present:</strong><br />

      <input name="is_present" type="radio"  id="is_present1" value="1" <?php if($info['is_present'] == 1): ?>checked<?php endif; ?>>  yes  
      <input name="is_present" type="radio"  id="is_present2" value="0" <?php if($info['is_present'] == 0): ?>checked<?php endif; ?>>  no      </td>
    </tr>
    <tr align="left" valign="top">
    ...
    <tr align="left" valign="top">
      <td colspan="2"><strong>Item Option:</strong>
      <?php if(is_array($item_config)): foreach($item_config as $k=>$vo): ?><input name="item_config[<?php echo ($vo); ?>]" type="checkbox" id="price" value="1"><?php echo ($vo); ?><?php endforeach; endif; ?> 
      </td>
    </tr>
    <!-- <tr align="left" valign="top">
