  ...
  <table width="100%" border="0"  cellpadding="4" cellspacing="0" class="listig_table">
     <tr>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
        ...
        <td><?php echo ($vo["date_from"]); ?> -- <?php echo ($vo["date_to"]); ?></td>
        <td><?php if($vo['status'] == 1): ?><a class="on" href="javascript:;" data-id="<?php echo ($vo["id"]); ?>"><span class="on_show" style="color:green;">ON</span></a><?php else: ?><a class="off"  href="javascript:;" data-id="<?php echo ($vo["id"]); ?>"><span style="color:red;">OFF</span></a><?php endif; ?> | <a href="__APP__/Coupons/edit/id/<?php echo ($vo["id"]); ?>">Edit</a> | <a href="__APP__/Coupons/delete/id/<?php echo ($vo["id"]); ?>" onclick="confirm('Are you sure to delete!')"> Delete</a></td>
